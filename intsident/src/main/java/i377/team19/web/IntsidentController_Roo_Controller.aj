...
privileged aspect IntsidentController_Roo_Controller {
    ...
    @ModelAttribute("loiks")
    public Collection<Loik> IntsidentController.populateLoiks() {
        return Arrays.asList(Loik.class.getEnumConstants());
    }
    
    @ModelAttribute("seaduses")
    public Collection<Seadus> IntsidentController.populateSeaduses() {
        return Arrays.asList(Seadus.class.getEnumConstants());
    }
